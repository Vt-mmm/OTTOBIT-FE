...
const EmailConfirmationSection: React.FC<EmailConfirmationSectionProps> = ({
  ...
  const handleResendEmail = async () => {
    try {
      ...
      setResult({
        message: translate("auth.EmailVerificationResent"),
        errors: null,
        errorCode: null,
        timestamp: new Date().toISOString(),
      });
        ...
        >
          ...
          {isLoading ? (
            ...
            >
              ...
              >
                {translate("auth.VerifyingEmailProgress")}
              </Typography>
              <Typography
                variant="body1"
                sx={{
              ...
              >
                {translate("auth.PleaseWaitMoment")}
              </Typography>
            </motion.div>
          ) : (
            <>
              {result && !result.errors && !result.errorCode ? (
                ...
                >
                  ...
                  >
                    {isAlreadyConfirmed
                      ? translate("auth.EmailAlreadyConfirmed")
                      : translate("auth.ConfirmationSuccess")}
                  </Typography>
                  ...
                  >
                    {isAlreadyConfirmed
                      ? translate("auth.EmailAlreadyConfirmedContent")
                      : translate("auth.AccountActivatedSuccess")}
                  </Typography>
                ...
                >
                  ...
                  >
                    {translate("auth.ConfirmationFailed")}
                  </Typography>
