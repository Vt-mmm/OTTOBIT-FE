    ...
    <Box>
      ...
      >
        <DialogContent>
          ...
          <Typography variant="body1" sx={{ mb: 3 }}>
            Are you sure you want to delete "{robot.name}"? This will
            soft-delete the product and it can be restored later.
          </Typography>
      ...
      >
        <DialogContent>
          ...
          <Typography variant="body1" sx={{ mb: 3 }}>
            Are you sure you want to restore "{robot.name}"? This will make the
