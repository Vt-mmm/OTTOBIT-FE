import { Card, CardContent, Typography, Box, Skeleton, ToggleButtonGroup, ToggleButton, Fade, CircularProgress } from "@mui/material";
import {
  LineChart,
  Line,
  XAxis,
...
export default function RevenueChart({ data, isLoading, selectedDays, onDaysChange }: RevenueChartProps) {
    ...
    <Card>
      <CardContent>
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 3 }}>
          ...
          >
            <ToggleButton value={7}>7 {translate("admin.dashboardStats.days")}</ToggleButton>
            <ToggleButton value={14}>14 {translate("admin.dashboardStats.days")}</ToggleButton>
            <ToggleButton value={30}>30 {translate("admin.dashboardStats.days")}</ToggleButton>
          </ToggleButtonGroup>
        </Box>
            ...
            <Tooltip
              ...
              formatter={(value: number, name: string) => [
                name === "revenue"
                  ...
                  : value,
                name === "revenue" ? translate("admin.dashboardStats.revenue") : translate("admin.dashboardStats.orders"),
              ]}
            />
            <Legend
              wrapperStyle={{ paddingTop: '20px' }}
              formatter={(value) =>
                value === "revenue" ? translate("admin.dashboardStats.revenue") : translate("admin.dashboardStats.orders")
              }
            />
            <Line
              yAxisId="left"
