...
export const studioTourSteps: DriveStep[] = [
  // Intro: Top bar area overview
  {
    ...
    onDeselected: (element, _step, { driver }) => {
      try {
        driver.setConfig({ ...driver.getConfig(), overlayOpacity: 0.1 });
      } catch {}
  ...
  // Challenge selector
  {
    ...
    popover: {
      ...
      description:
        "Chọn nhanh challenge trong bài học. Những map bị khóa cần hoàn thành map trước đó.",
      side: "bottom",
      align: "center",
      popoverClass: "studio-popover",
    },
  ...
  // Buttons group (gộp)
  {
    ...
    popover: {
      ...
      description:
        "Từ trái qua phải: gửi micro:bit, mở camera, gợi ý, cờ, chạy/dừng, tải lại map.",
      side: "bottom",
      align: "center",
      popoverClass: "studio-popover",
    },
  ...
  // Left: Toolbox categories
  {
    ...
    popover: {
      title: "Toolbox",
      description:
        "Chọn nhóm khối lệnh. Khi kéo thả xong, toolbox auto đóng để tập trung vào workspace.",
      side: "right",
      align: "center",
      popoverClass: "studio-popover",
    },
  ...
  // Center-left: Workspace area
  {
    ...
    popover: {
      ...
      description:
        "Kéo thả khối lệnh để tạo chương trình. Bạn có thể phóng to/thu nhỏ và kéo để di chuyển khung nhìn.",
      side: "right",
      align: "start",
      popoverClass: "studio-popover",
    },
  ...
  // Right: Simulator container
  {
    ...
    popover: {
      ...
      description:
        "Khu vực mô phỏng robot. Kết quả chạy, trạng thái và điểm số sẽ hiển thị tại đây.",
      side: "left",
      align: "center",
      popoverClass: "studio-popover",
    },
  },
  {
    ...
    popover: {
      ...
      description:
        "Xem nhanh map hiện tại và trạng thái chương trình (đang chạy/hoàn thành).",
      side: "left",
      align: "start",
      popoverClass: "studio-popover",
    },
